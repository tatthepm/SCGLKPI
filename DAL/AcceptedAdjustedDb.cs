...
namespace DAL {
   public class AcceptedAdjustedDb {
        ...
        {
            return db.AcceptedAdjusted.Where(x => x.DEPARTMENT_ID == department_id && x.SECTION_ID == section_id && x.PLNACPDDATE_D.Value.Year == year && x.PLNACPDDATE_D.Value.Month == month).Take(1000);
        }
        //GetById
