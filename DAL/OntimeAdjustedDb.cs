...
namespace DAL {
    public class OntimeAdjustedDb {
        ...
        {
            return db.OntimeAdjusted.Where(x => x.DEPARTMENT_ID == department_id && x.SECTION_ID == section_id && x.PLNONTIMEDATE_D.Value.Year == year && x.PLNONTIMEDATE_D.Value.Month == month);
        }
