...
namespace DAL {
    public class OutboundAdjustedDb {
        ...
        {
            return db.OutboundAdjusted.Where(x => x.DEPARTMENT_ID == department_id && x.SECTION_ID == section_id && x.ACDLVDATE_D.Value.Year == year && x.ACDLVDATE_D.Value.Month == month).Take(1000);
        }
        //GetById
