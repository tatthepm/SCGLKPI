...
namespace DAL {
    public class InboundAdjustedDb {
        ...
        {
            return db.InboundAdjusted.Where(x => x.DEPARTMENT_ID == department_id && x.SECTION_ID == section_id && x.PLNINBDATE_D.Value.Year == year && x.PLNINBDATE_D.Value.Month == month).Take(1000);
        }
