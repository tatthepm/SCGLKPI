namespace BOL.Migrations
{
    ...
    public partial class createInboundDelays : DbMigration
    {
        ...
        {
            DropIndex("dbo.InboundDelays", new[] { "ACTGIDATE_D" });
            DropIndex("dbo.InboundDelays", new[] { "SECTION_ID" });
            DropIndex("dbo.InboundDelays", new[] { "DEPARTMENT_ID" });
            DropIndex("dbo.InboundDelays", new[] { "MATFRIGRP" });
            DropTable("dbo.InboundDelays");
        }
    }
}
